...
export const slackChannelConfigUiHints = {
  ...
  ...createChannelConfigUiHints({
    ...
    streaming: {
      ...
      "progress.style":
        'Slack progress presentation: "card" uses structured task/session cards; "compact" keeps one editable text draft that the final answer replaces in place when Slack can safely edit it. Defaults to "compact" when progress.toolProgress is explicitly false, otherwise "card".',
